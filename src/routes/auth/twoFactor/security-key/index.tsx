import VerifyUserSecurityKeyForm from "@/components/auth/verify-security-key-form";
...
export const Route = createFileRoute("/auth/twoFactor/security-key/")({
...
function RouteComponent() {
	...
	return (
		<div>
			<VerifyUserSecurityKeyForm encodedCredentialIds={credentials} />
		</div>
	);
}
